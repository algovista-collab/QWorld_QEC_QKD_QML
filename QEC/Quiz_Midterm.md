...
* **$X_0$ and $X_1 X_2$:** These are bit-flip errors. They trigger the $ZZ$ stabilizers within Block 0. X0 flips 0th bit - we get 100+011 and X1X2 flips 1 and 2 bits we get - 011+100 which is same X0, hence they match.
